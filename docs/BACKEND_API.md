...
/api/booking/save/{timeslotId}|POST|id of timeslot as path variable, (id of customer in request body, not currently implemented)|Timeslot including booking or error message|Creates a booking for a timeslot
