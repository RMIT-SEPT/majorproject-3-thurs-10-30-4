...
/api/booking/save/{timeslotId} (not implemented)|POST|id of timeslot as path variable, id of customer in request body|Booking created or error message|Creates a booking for a timeslot
